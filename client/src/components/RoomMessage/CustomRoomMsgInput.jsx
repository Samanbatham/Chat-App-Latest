...
import useSendCustomMessage from "../../hooks/useSendCustomMessage";
import { useRef } from "react";
function CustomRoomMsgInput() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (message.trim()) {
      await sendCustomMessage(newMessage);
      setMessage("");
      setEmoji(false)
    }
  };
...
export default CustomRoomMsgInput;
